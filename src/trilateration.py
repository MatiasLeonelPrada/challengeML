"""This module has the Trilateration and NotValidSatellites Classes implementation."""
import numpy as np
...
class Trilateration:
    ...
    def get_location(self, distances):
        ...
        C = distances[0]**2 - distances[1]**2 - positions[0][0]**2 + positions[1][0]**2\
            - positions[0][1]**2 + positions[1][1]**2
        D = -2 * positions[1][0] + 2 * positions[2][0]
        E = -2 * positions[1][1] + 2 * positions[2][1]
        F = distances[1]**2 - distances[2]**2 - positions[1][0]**2 + positions[2][0]**2\
            - positions[1][1]**2 + positions[2][1]**2
